...
- The agent runs linters, type checks, builds and unit tests itself before committing, skipping what a pure docs or config change doesn't need. A failure is a non-zero exit code, not a warning.
